...
bool ExampleNexys::EDROOMIsComponentFinished()
{
	...
	return ( SystemMng.EDROOMIsComponentFinished() && LEDMng.EDROOMIsComponentFinished() && DisplaysMng.EDROOMIsComponentFinished() && CEDROOMComponent::EDROOMIsComponentFinished());
