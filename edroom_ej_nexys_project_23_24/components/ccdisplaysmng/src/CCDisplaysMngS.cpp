...
CCDisplaysMng::CCDisplaysMng(TEDROOMComponentID id,
...
int CCDisplaysMng::EDROOMConfig()
{
...
void CCDisplaysMng::EDROOMBehaviour()
{
...
bool CCDisplaysMng::EDROOMIsComponentFinished()
{
...
void CCDisplaysMng::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,
